...
namespace SchemaMigration
{
    public class ActionOnSchemas
    {
        ...
        public List<SchemaDetails> GetListOfSchemas(string sqlConnectionString, string outputDir, string parameter)
        {
            ...
            using (SqlConnection cn = new SqlConnection(sqlConnectionString))
            {
                var query = ConfigurationManager.AppSettings["SchemaQueryApplication"];
